...
class UserController extends AbstractController
{
    ...
    public function login()
    {
        ...
        $form->startForm()
            ...
            ->addInput('email', 'user-email', ['class' => 'form-control', 'id' => 'user-email'])
            ->endDiv()
            ->startDiv('col-md mb-3')
            ->addLabelFor('pass', 'Mot de passe :', ['class' => 'mb-3 form-label'])
            ->addInput('password', 'user-password', ['class' => 'form-control', 'id' => 'user-password'])
            ->endDiv()
            ->startDiv('col-md-4 my-4')
            ->addButton('Me connecter', ['class' => 'btn btn-primary w-100'])
            ->endDiv()
            ->endForm();
